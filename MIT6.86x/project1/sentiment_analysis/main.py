...
train_bow_features = p1.extract_bow_feature_vectors(
    train_texts, dictionary, binarize=False
)
val_bow_features = p1.extract_bow_feature_vectors(val_texts, dictionary, binarize=False)
test_bow_features = p1.extract_bow_feature_vectors(
    test_texts, dictionary, binarize=False
)
...
T = 25
L = 0.01
best_peg_train_accuracy, best_peg_test_accuracy = p1.classifier_accuracy(
    p1.pegasos,
    train_bow_features,
    test_bow_features,
    train_labels,
...
print(f"Test accuracy for Pegasos: {best_peg_test_accuracy:.4f}")
...
# T = 25
# L = 0.01
# best_theta, best_theta_0 = p1.pegasos(
#     train_bow_features,
#     train_labels,
#     T=T,
#     L=L,
